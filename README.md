...
[![PyPI](https://img.shields.io/pypi/v/cognis-ssltriage.svg)](https://pypi.org/project/cognis-ssltriage/)
[![CI](https://github.com/cognis-digital/ssltriage/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/ssltriage/actions)
...
SSLTRIAGE exists for one job — grade tls config (protocols/ciphers/expiry) from openssl/sslyze output — and does it without a SaaS bill or heavyweight setup.
...
```bash
ssltriage --version
ssltriage scan .                      # scan the current project
ssltriage scan . --format json
ssltriage scan . --fail-on high       # non-zero exit for CI gates
ssltriage mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **testssl.sh**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`ssltriage` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
