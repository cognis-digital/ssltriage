#!/usr/bin/env sh
# Universal installer for ssltriage. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ssltriage.git"
echo "Installing ssltriage ..."
