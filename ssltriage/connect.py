"""Native cognis-connect emit for ssltriage — forward findings to any platform.

Maps ssltriage's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    ssltriage ... --format json | ssltriage-emit --to stix
    ssltriage-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
