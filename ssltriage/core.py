"""SSLTRIAGE core — Grade TLS config (protocols/ciphers/expiry) from openssl/sslyze output."""
...
RULES = [
    ("SSL-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SSL-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SSL-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
